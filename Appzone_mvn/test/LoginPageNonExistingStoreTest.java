...
public class LoginPageNonExistingStoreTest implements TestsInterface {
	...
	private static final Logger LOGGER = Logger.getLogger(LoginPageNonExistingStoreTest.class);
