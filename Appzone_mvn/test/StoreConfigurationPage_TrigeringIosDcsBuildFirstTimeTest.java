...
public class StoreConfigurationPage_TrigeringIosDcsBuildFirstTimeTest implements TestsInterface {
	
	private WebDriver driver;
	
	private static final Logger LOGGER = Logger.getLogger(StoreConfigurationPage_TrigeringIosDcsBuildFirstTimeTest.class);
