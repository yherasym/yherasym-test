...
import com.partnerpedia.appzone.web.pageobject.libs.ForgotPasswordPage;
import com.partnerpedia.appzone.web.pageobject.libs.LoginPage;

public class LoginPageBlockingUserByMaxLoginAttemptsTest implements TestsInterface{
	...
	private static final Logger LOGGER = Logger.getLogger(LoginPageBlockingUserByMaxLoginAttemptsTest.class);
